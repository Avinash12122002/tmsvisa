          ...
          jobs.map((job, i) => (
            ...
            >
              ...
              <div className="md:px-5 md:py-4 flex items-center gap-2 md:block">
                ...
                <button
                  onClick={() => window.location.href = `https://tmsvisa.vercel.app/job/${job._id}`, "_blank"}
              ...
              <div className="md:px-5 md:py-4 md:flex md:justify-center">
                <button
                  onClick={() =>window.location.href=`https://tmsvisa.vercel.app/jobs/apply/${job._id}`, "_blank"}
